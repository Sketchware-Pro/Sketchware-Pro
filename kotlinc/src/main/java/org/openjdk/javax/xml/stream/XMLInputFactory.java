 ...
 *        <th>Required</th>
 *      </tr>
 * <tr><td>org.openjdk.javax.xml.stream.isValidating</td><td>Turns on/off implementation specific DTD validation</td><td>Boolean</td><td>False</td><td>No</td></tr>
 * <tr><td>org.openjdk.javax.xml.stream.isNamespaceAware</td><td>Turns on/off namespace processing for XML 1.0 support</td><td>Boolean</td><td>True</td><td>True (required) / False (optional)</td></tr>
 * <tr><td>org.openjdk.javax.xml.stream.isCoalescing</td><td>Requires the processor to coalesce adjacent character data</td><td>Boolean</td><td>False</td><td>Yes</td></tr>
 * <tr><td>org.openjdk.javax.xml.stream.isReplacingEntityReferences</td><td>replace internal entity references with their replacement text and report them as characters</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>org.openjdk.javax.xml.stream.isSupportingExternalEntities</td><td>Resolve external parsed entities</td><td>Boolean</td><td>Unspecified</td><td>Yes</td></tr>
 *<tr><td>org.openjdk.javax.xml.stream.supportDTD</td><td>Use this property to request processors that do not support DTDs</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>org.openjdk.javax.xml.stream.reporter</td><td>sets/gets the impl of the XMLReporter </td><td>org.openjdk.javax.xml.stream.XMLReporter</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>org.openjdk.javax.xml.stream.resolver</td><td>sets/gets the impl of the XMLResolver interface</td><td>org.openjdk.javax.xml.stream.XMLResolver</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>org.openjdk.javax.xml.stream.allocator</td><td>sets/gets the impl of the XMLEventAllocator interface</td><td>org.openjdk.javax.xml.stream.util.XMLEventAllocator</td><td>Null</td><td>Yes</td></tr>
 *    </tbody>
 *  </table>
 *
 *
...
public abstract class XMLInputFactory {
  ...
  public static final String IS_NAMESPACE_AWARE=
    "org.openjdk.javax.xml.stream.isNamespaceAware";

  /**
   * The property used to turn on/off implementation specific validation
   */
  public static final String IS_VALIDATING=
    "org.openjdk.javax.xml.stream.isValidating";

  /**
   * The property that requires the parser to coalesce adjacent character data sections
   */
  public static final String IS_COALESCING=
    "org.openjdk.javax.xml.stream.isCoalescing";
  ...
  public static final String IS_REPLACING_ENTITY_REFERENCES=
    "org.openjdk.javax.xml.stream.isReplacingEntityReferences";

  /**
   *  The property that requires the parser to resolve external parsed entities
   */
  public static final String IS_SUPPORTING_EXTERNAL_ENTITIES=
    "org.openjdk.javax.xml.stream.isSupportingExternalEntities";

  /**
   *  The property that requires the parser to support DTDs
   */
  public static final String SUPPORT_DTD=
    "org.openjdk.javax.xml.stream.supportDTD";
  ...
  public static final String REPORTER=
    "org.openjdk.javax.xml.stream.reporter";

  /**
   * The property used to set/get the implementation of the XMLResolver
   */
  public static final String RESOLVER=
    "org.openjdk.javax.xml.stream.resolver";

  /**
   * The property used to set/get the implementation of the allocator
   */
  public static final String ALLOCATOR=
    "org.openjdk.javax.xml.stream.allocator";
   ...
   * <ul>
   * <li>
   *   Use the org.openjdk.javax.xml.stream.XMLInputFactory system property.
   * </li>
   * <li>
   ...
   * </li>
   * <li>
   *   If {@code factoryId} is "org.openjdk.javax.xml.stream.XMLInputFactory",
   *   use the service-provider loading facilities, defined by the
   *   {@link java.util.ServiceLoader} class, to attempt to locate and load an
