 ...
 * org.openjdk.javax.xml.stream.notations and org.openjdk.javax.xml.stream.entities.
 * When the current event is a DTD the following call will return a
 * list of Notations
 *  <code>List l = (List) getProperty("org.openjdk.javax.xml.stream.notations");</code>
 * The following call will return a list of entity declarations:
 * <code>List l = (List) getProperty("org.openjdk.javax.xml.stream.entities");</code>
...
public interface XMLStreamReader extends XMLStreamConstants {
   ...
   * If the property org.openjdk.javax.xml.stream.isCoalescing is set to true
   ...
   * Regardless of value of org.openjdk.javax.xml.stream.isCoalescing this method always returns coalesced content.
