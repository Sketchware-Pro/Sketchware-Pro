...
public abstract class XMLEventFactory {
  protected XMLEventFactory(){}
    ...
    static final String JAXPFACTORYID = "org.openjdk.javax.xml.stream.XMLEventFactory";
   ...
   * <ul>
   * <li>
   *   Use the org.openjdk.javax.xml.stream.XMLEventFactory system property.
   * </li>
   * <li>
   ...
   * </li>
   * <li>
   *   If {@code factoryId} is "org.openjdk.javax.xml.stream.XMLEventFactory",
   *   use the service-provider loading facilities, defined by the
   *   {@link java.util.ServiceLoader} class, to attempt to locate and load an
