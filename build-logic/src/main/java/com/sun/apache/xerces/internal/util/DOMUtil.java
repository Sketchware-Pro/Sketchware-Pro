...
import com.sun.apache.xerces.internal.impl.xs.opti.NodeImpl;
...
public class DOMUtil {
    ...
    public static void setHidden(Node node) {
        ...
        else if (node instanceof com.sun.apache.xerces.internal.dom.NodeImpl)
            ((com.sun.apache.xerces.internal.dom.NodeImpl)node).setReadOnly(true, false);
    } // setHidden(node):void
    ...
    public static void setVisible(Node node) {
        if (node instanceof NodeImpl)
            ...
            ((com.sun.apache.xerces.internal.dom.NodeImpl)node).setReadOnly(false, false);
    ...
    public static boolean isHidden(Node node) {
        if (node instanceof NodeImpl)
            ...
            return ((com.sun.apache.xerces.internal.dom.NodeImpl)node).getReadOnly();
        return false;
