...
public class ImportMoreblockHelper {
    ...
    public static TextView optimizedBlockView(Context context, String str) {
        TextView textView = (TextView) ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(Resources.layout.block_customview, (ViewGroup) null).findViewById(Resources.id.spec);
