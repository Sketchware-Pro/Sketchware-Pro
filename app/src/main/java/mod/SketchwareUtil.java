...
public class SketchwareUtil {
	...
	/**
	 * Show a Toast with a Sketchware style.
	 * @param string The content of the Toast
	 */
	public static void toast(String string) {
		bB.a(getContext(), string, Toast.LENGTH_SHORT).show();
	}

	/**
	 * Show an Error-toast with a Sketchware style
	 * @param string The content of the Toaast
	 */
	public static void toastError(String string) {
		bB.b(getContext(), string, Toast.LENGTH_SHORT).show();
	}
}
