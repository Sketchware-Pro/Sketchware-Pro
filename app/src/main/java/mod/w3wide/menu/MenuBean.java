	...
	public void projectMenu(Ss ss, AsdAll asdAll, ArrayList<String> selectableItems) {
		...
		switch (menuName) {
			case "ResString":
				...
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "string\\sname=\\\"(.*?)\\\""));
				break;

			case "ResStyle":
				asdAll.b("Select a resource Style");
				selectableItems.addAll(readResNames(ResourcePath.getStylePath(sc_id), "style\\sname=\\\"(.*?)\\\""));
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "style\\sname=\\\"(.*?)\\\""));
				break;
			...
			case "ResColor":
				...
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "color\\sname=\\\"(.*?)\\\""));
				break;
			...
			case "ResArray":
				...
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "string-array\\sname=\\\"(.*?)\\\""));
				break;

			case "ResDimen":
				asdAll.b("Select a resource Dimension");
				selectableItems.addAll(readResNames(ResourcePath.getDimenPath(sc_id), "dimen\\sname=\\\"(.*?)\\\""));
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "dimen\\sname=\\\"(.*?)\\\""));
				break;

			case "ResBool":
				asdAll.b("Select a resource Boolean");
				selectableItems.addAll(readResNames(ResourcePath.getBoolPath(sc_id), "bool\\sname=\\\"(.*?)\\\""));
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "bool\\sname=\\\"(.*?)\\\""));
				break;
				
			case "ResInteger":
				asdAll.b("Select a resource Integer");
				selectableItems.addAll(readResNames(ResourcePath.getIntegerPath(sc_id), "integer\\sname=\\\"(.*?)\\\""));
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "integer\\sname=\\\"(.*?)\\\""));
				break;

			case "ResAttr":
				asdAll.b("Select a resource Attribute");
				selectableItems.addAll(readResNames(ResourcePath.getAttrPath(sc_id), "attr\\sname=\\\"(.*?)\\\""));
				selectableItems.addAll(readResNames(ResourcePath.getValuesPath(sc_id), "attr\\sname=\\\"(.*?)\\\""));
				break;
