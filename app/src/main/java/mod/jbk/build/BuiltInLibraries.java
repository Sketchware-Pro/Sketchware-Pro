...
public class BuiltInLibraries {
    ...
    public static String ANDROIDX_ANNOTATION = "annotation-jvm-1.9.1";
    ...
    public static String ANDROIDX_COLLECTION = "collection-jvm-1.4.5";
    public static String ANDROIDX_CONCURRENT_FUTURES = "concurrent-futures-1.2.0";
    ...
    public static String ANDROIDX_CORE = "core-1.15.0";
    public static String ANDROIDX_CORE_COMMON = "core-common-2.2.0";
    public static String ANDROIDX_CORE_KTX = "core-ktx-1.15.0";
    ...
    public static String ANDROIDX_FRAGMENT = "fragment-1.8.5";
    ...
    public static String ANDROIDX_LIFECYCLE_COMMON = "lifecycle-common-jvm-2.8.7";
    public static String ANDROIDX_LIFECYCLE_LIVEDATA = "lifecycle-livedata-2.8.7";
    public static String ANDROIDX_LIFECYCLE_LIVEDATA_CORE = "lifecycle-livedata-core-2.8.7";
    public static String ANDROIDX_LIFECYCLE_PROCESS = "lifecycle-process-2.8.7";
    public static String ANDROIDX_LIFECYCLE_RUNTIME = "lifecycle-runtime-release";
    public static String ANDROIDX_LIFECYCLE_SERVICE = "lifecycle-service-2.8.7";
    ...
    public static String ANDROIDX_SLIDINGPANELAYOUT = "slidingpanelayout-1.2.0";
    ...
    public static String ANDROIDX_TRANSITION = "transition-1.5.1";
    ...
    public static String ANDROIDX_VERSIONEDPARCELABLE = "versionedparcelable-1.2.0";
    public static String ANDROIDX_VIEWPAGER2 = "viewpager2-1.1.0";
    public static String ANDROIDX_VIEWPAGER = "viewpager-1.0.0";
    public static String ANDROIDX_WEBKIT = "webkit-1.11.0-alpha02";
    public static String ANDROIDX_WINDOW = "window-1.0.0";
    ...
    public static String FIREBASE_IID = "firebase-iid-21.1.0";
    ...
    public static String FIREBASE_MEASUREMENT_CONNECTOR = "firebase-measurement-connector-20.0.1";
    ...
    public static String FACEBOOK_ADS_AUDIENCE_NETWORK_SDK = "audience-network-sdk-6.18.0";
    ...
    public static String GOOGLE_ERROR_PRONE_ANNOTATIONS = "error_prone_annotations-2.27.0";
    public static String GOOGLE_ID = "googleid-1.1.0";
    public static String GOOGLE_J2OBJC_ANNOTATIONS = "j2objc-annotations-1.3";
    public static String GOOGLE_FINDBUGS_JSR305 = "jsr305-3.0.2";
    public static String GOOGLE_RECAPTCHA = "recaptcha-18.5.1";
    public static String GOOGLE_TRANSPORT_API = "transport-api-3.1.9";
    ...
    public static String GUAVA_FAILUREACCESS = "failureaccess-1.0.1";
    ...
    public static String OKIO = "okio-jvm-3.6.0";
    public static String ONESIGNAL = "OneSignal-5.1.23";
    public static String ONESIGNAL_CORE = "core-5.1.23";
    public static String ONESIGNAL_IN_APP_MESSAGING = "in-app-messaging-5.1.23";
    ...
    public static String PLAY_SERVICES_ADS = "play-services-ads-23.5.0";
    public static String PLAY_SERVICES_ADS_BASE = "play-services-ads-base-23.5.0";
    public static String PLAY_SERVICES_ADS_IDENTIFIER = "play-services-ads-identifier-18.1.0";
    public static String PLAY_SERVICES_ADS_LITE = "play-services-ads-lite-23.5.0";
    public static String PLAY_SERVICES_APPSET = "play-services-appset-16.1.0";
    public static String PLAY_SERVICES_AUTH = "play-services-auth-21.2.0";
    public static String PLAY_SERVICES_AUTH_API_PHONE = "play-services-auth-api-phone-18.1.0";
    public static String PLAY_SERVICES_AUTH_BASE = "play-services-auth-base-18.0.13";
    public static String PLAY_SERVICES_BASE = "play-services-base-18.5.0";
    public static String PLAY_SERVICES_BASEMENT = "play-services-basement-18.5.0";
    ...
    public static String PLAY_SERVICES_MEASUREMENT_BASE = "play-services-measurement-base-22.1.2";
    public static String PLAY_SERVICES_MEASUREMENT_SDK_API = "play-services-measurement-sdk-api-22.1.2";
    ...
    public static String PRIVACYSANDBOX_ADSSERVICES = "ads-adservices-1.0.0-beta05";
    public static String PRIVACYSANDBOX_ADSSERVICES_JAVA = "ads-adservices-java-1.0.0-beta05";
    public static String UMP_USER_MESSAGING_PLATFORM = "user-messaging-platform-3.1.0";
    ...
    public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
            new BuiltInLibrary(ANDROIDX_ACTIVITY, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION, ANDROIDX_CORE, ANDROIDX_LIFECYCLE_RUNTIME,
                    ...
                    ANDROIDX_PROFILEINSTALLER, KOTLIN_STDLIB), "androidx.activity"),

            new BuiltInLibrary(ANDROIDX_ANNOTATION, List.of(KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_APPCOMPAT, List.of(ANDROIDX_ACTIVITY, ANDROIDX_ANNOTATION, ANDROIDX_APPCOMPAT_RESOURCES, ANDROIDX_COLLECTION,
                    ANDROIDX_CORE, ANDROIDX_CORE_KTX, ANDROIDX_CURSORADAPTER, ANDROIDX_DRAWERLAYOUT, ANDROIDX_EMOJI2, ANDROIDX_EMOJI2_VIEWS_HELPER, ANDROIDX_FRAGMENT,
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_VIEWMODEL, ANDROIDX_PROFILEINSTALLER, ANDROIDX_RESOURCEINSPECTION_ANNOTATION,
            ...
            new BuiltInLibrary(ANDROIDX_CORE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_COLLECTION,
                    ...
                    ANDROIDX_TRACING, ANDROIDX_VERSIONEDPARCELABLE, KOTLIN_STDLIB), "androidx.core"),

            new BuiltInLibrary(ANDROIDX_CORE_KTX, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_DYNAMIC_ANIMATION, List.of(ANDROIDX_COLLECTION, ANDROIDX_CORE)),
            new BuiltInLibrary(ANDROIDX_EMOJI2, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION,
                    ANDROIDX_EMOJI2_VIEWS_HELPER, ANDROIDX_CORE, ANDROIDX_LIFECYCLE_PROCESS,
            ...
            new BuiltInLibrary(ANDROIDX_FRAGMENT, List.of(ANDROIDX_ACTIVITY, ANDROIDX_ANNOTATION, ANDROIDX_ANNOTATION_EXPERIMENTAL,
                    ...
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, ANDROIDX_LOADER, ANDROIDX_PROFILEINSTALLER,
                    ANDROIDX_SAVEDSTATE, ANDROIDX_VIEWPAGER, KOTLIN_STDLIB), "androidx.fragment"),

            new BuiltInLibrary(ANDROIDX_INTERPOLATOR, List.of(ANDROIDX_ANNOTATION)),
            new BuiltInLibrary(ANDROIDX_LEGACY_SUPPORT_CORE_UI, List.of(ANDROIDX_ANNOTATION, ANDROIDX_ASYNCLAYOUTINFLATER,
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_COMMON, List.of(ANDROIDX_ANNOTATION,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA, ANDROIDX_LIFECYCLE_PROCESS,
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE)),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_LIVEDATA, List.of(ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME,
                    ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_PROCESS,
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL, KOTLIN_STDLIB, KOTLIN_COROUTINES_CORE_JVM)),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_LIVEDATA_CORE, List.of(ANDROIDX_CORE_COMMON, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL, KOTLIN_STDLIB)),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_PROCESS, List.of(ANDROIDX_ANNOTATION, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
                    ANDROIDX_LIFECYCLE_LIVEDATA, ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL, ANDROIDX_STARTUP_RUNTIME, KOTLIN_STDLIB)),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_RUNTIME, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE_COMMON, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
                    ANDROIDX_LIFECYCLE_LIVEDATA, ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL, ANDROIDX_PROFILEINSTALLER, KOTLIN_STDLIB, KOTLIN_COROUTINES_ANDROID), "androidx.lifecycle.runtime"),

            new BuiltInLibrary(ANDROIDX_LIFECYCLE_SERVICE, List.of(ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, ANDROIDX_LIFECYCLE_VIEWMODEL, KOTLIN_STDLIB)),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_VIEWMODEL, List.of(ANDROIDX_ANNOTATION, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, KOTLIN_STDLIB,
                    KOTLIN_COROUTINES_ANDROID, KOTLIN_COROUTINES_CORE_JVM), "androidx.lifecycle.viewmodel"),
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE_KTX, ANDROIDX_LIFECYCLE_COMMON,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA, ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL, ANDROIDX_SAVEDSTATE, KOTLIN_STDLIB, KOTLIN_COROUTINES_ANDROID)),

            new BuiltInLibrary(ANDROIDX_LOADER, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION, ANDROIDX_CORE,
                    ANDROIDX_LIFECYCLE_LIVEDATA, ANDROIDX_LIFECYCLE_VIEWMODEL)),
            new BuiltInLibrary(ANDROIDX_LOCALBROADCASTMANAGER, List.of(ANDROIDX_ANNOTATION)),
            new BuiltInLibrary(ANDROIDX_MEDIA, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION, ANDROIDX_CORE), "androidx.media"),
            ...
            new BuiltInLibrary(ANDROIDX_SAVEDSTATE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE_COMMON,
                    KOTLIN_STDLIB, ANDROIDX_LIFECYCLE_COMMON),
                    "androidx.savedstate"),

            new BuiltInLibrary(ANDROIDX_SLIDINGPANELAYOUT, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE,
                    ANDROIDX_CUSTOMVIEW, ANDROIDX_TRANSITION, ANDROIDX_WINDOW)),
            new BuiltInLibrary(ANDROIDX_SQLITE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_SQLITE_FRAMEWORK, KOTLIN_STDLIB)),
            new BuiltInLibrary(ANDROIDX_SQLITE_FRAMEWORK, List.of(ANDROIDX_ANNOTATION, ANDROIDX_SQLITE, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_TRANSITION, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION,
                    ANDROIDX_DYNAMIC_ANIMATION, ANDROIDX_CORE), "androidx.transition"),
            new BuiltInLibrary(ANDROIDX_VECTORDRAWABLE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION, ANDROIDX_CORE)),
            new BuiltInLibrary(ANDROIDX_VECTORDRAWABLE_ANIMATED, List.of(ANDROIDX_COLLECTION, ANDROIDX_INTERPOLATOR,
                    ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_VECTORDRAWABLE)),
            ...
            new BuiltInLibrary(ANDROIDX_WORK_RUNTIME, List.of(ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_ROOM_RUNTIME, ANDROIDX_SQLITE_FRAMEWORK,
                    ANDROIDX_STARTUP_RUNTIME, KOTLIN_STDLIB), "androidx.work"),
            new BuiltInLibrary(ANDROIDX_WORK_RUNTIME_KTX, List.of(ANDROIDX_WORK_RUNTIME, KOTLIN_STDLIB, KOTLIN_COROUTINES_ANDROID)),
            ...
            new BuiltInLibrary(FIREBASE_APPCHECK, List.of(ANDROIDX_ANNOTATION, PLAY_SERVICES_BASE, PLAY_SERVICES_TASKS,
                    FIREBASE_APPCHECK_INTEROP, FIREBASE_COMMON_KTX, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(FIREBASE_DATABASE, List.of(ANDROIDX_ANNOTATION, FIREBASE_AUTH_INTEROP, FIREBASE_APPCHECK_INTEROP, FIREBASE_COMMON,
                    FIREBASE_COMMON_KTX, FIREBASE_COMPONENTS, FIREBASE_DATABASE_COLLECTION, KOTLIN_STDLIB, KOTLIN_COROUTINES_CORE_JVM,
            ...
            new BuiltInLibrary(FIREBASE_DATATRANSPORT, List.of(ANDROIDX_ANNOTATION, GOOGLE_TRANSPORT_API, GOOGLE_TRANSPORT_BACKEND_CCT, GOOGLE_TRANSPORT_RUNTIME)),
            new BuiltInLibrary(FIREBASE_ENCODERS, List.of(ANDROIDX_ANNOTATION)),
            new BuiltInLibrary(FIREBASE_ENCODERS_JSON, List.of(ANDROIDX_ANNOTATION, FIREBASE_ENCODERS)),
            new BuiltInLibrary(FIREBASE_ENCODERS_PROTO, List.of(ANDROIDX_ANNOTATION, FIREBASE_ENCODERS)),

            new BuiltInLibrary(FIREBASE_INSTALLATIONS, List.of(PLAY_SERVICES_TASKS, FIREBASE_ANNOTATIONS, FIREBASE_COMMON_KTX,
                    FIREBASE_COMMON, FIREBASE_COMPONENTS, FIREBASE_INSTALLATIONS_INTEROP,KOTLIN_STDLIB)),
            new BuiltInLibrary(FIREBASE_INSTALLATIONS_INTEROP, List.of(PLAY_SERVICES_TASKS, FIREBASE_ANNOTATIONS)),

            new BuiltInLibrary(FIREBASE_IID, List.of(ANDROIDX_COLLECTION, ANDROIDX_CORE, ANDROIDX_LEGACY_SUPPORT_CORE_UTILS,
                    PLAY_SERVICES_BASEMENT, PLAY_SERVICES_CLOUD_MESSAGING, PLAY_SERVICES_STATS, PLAY_SERVICES_TASKS, FIREBASE_COMMON,
                    FIREBASE_COMPONENTS, FIREBASE_IID_INTEROP, FIREBASE_INSTALLATIONS_INTEROP, FIREBASE_INSTALLATIONS)),
            ...
            new BuiltInLibrary(FIREBASE_MESSAGING, List.of(ANDROIDX_ANNOTATION, GOOGLE_TRANSPORT_API, GOOGLE_TRANSPORT_BACKEND_CCT,
                    GOOGLE_TRANSPORT_RUNTIME, PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_CLOUD_MESSAGING,
                    PLAY_SERVICES_STATS, PLAY_SERVICES_TASKS, GOOGLE_ERROR_PRONE_ANNOTATIONS, FIREBASE_COMMON_KTX, FIREBASE_COMMON,
                    FIREBASE_COMPONENTS, FIREBASE_DATATRANSPORT, FIREBASE_ENCODERS_JSON, FIREBASE_ENCODERS_PROTO, FIREBASE_ENCODERS,
                    FIREBASE_IID_INTEROP, FIREBASE_INSTALLATIONS_INTEROP, FIREBASE_INSTALLATIONS, FIREBASE_MEASUREMENT_CONNECTOR,
                    KOTLIN_STDLIB), "com.google.firebase.messaging"),

            new BuiltInLibrary(FIREBASE_STORAGE, List.of(FIREBASE_ANNOTATIONS, FIREBASE_APPCHECK_INTEROP, FIREBASE_APPCHECK,
                    FIREBASE_AUTH_INTEROP, FIREBASE_COMMON, FIREBASE_COMMON_KTX, FIREBASE_COMPONENTS, ANDROIDX_ANNOTATION,
                    PLAY_SERVICES_BASE, PLAY_SERVICES_TASKS, KOTLIN_STDLIB, KOTLIN_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(GOOGLE_FINDBUGS_JSR305),
            new BuiltInLibrary(GOOGLE_J2OBJC_ANNOTATIONS),
            new BuiltInLibrary(GUAVA, List.of(GOOGLE_FINDBUGS_JSR305, GOOGLE_ERROR_PRONE_ANNOTATIONS, GUAVA_FAILUREACCESS,
                    GOOGLE_J2OBJC_ANNOTATIONS, CHECKER_QUAL)),
            ...
            new BuiltInLibrary(GLIDE, List.of(GLIDE_ANNOTATIONS, GLIDE_DISKLRUCACHE, GLIDE_GIFDECODER, ANDROIDX_EXIFINTERFACE, ANDROIDX_FRAGMENT,
                    ANDROIDX_VECTORDRAWABLE_ANIMATED, ANDROIDX_TRACING), "com.bumptech.glide"),
            ...
            new BuiltInLibrary(GOOGLE_ID, List.of(KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(GOOGLE_TRANSPORT_API, List.of(ANDROIDX_ANNOTATION)),
            new BuiltInLibrary(GOOGLE_TRANSPORT_RUNTIME, List.of(ANDROIDX_ANNOTATION, GOOGLE_TRANSPORT_API,
                    FIREBASE_ENCODERS_JSON, FIREBASE_ENCODERS, JAVAX_INJECT)),
            new BuiltInLibrary(GOOGLE_TRANSPORT_BACKEND_CCT, List.of(ANDROIDX_ANNOTATION, GOOGLE_TRANSPORT_API,
                    GOOGLE_TRANSPORT_RUNTIME, FIREBASE_ENCODERS_JSON, FIREBASE_ENCODERS)),
            ...
            new BuiltInLibrary(MATERIAL, List.of(ANDROIDX_ANNOTATION, ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_APPCOMPAT, ANDROIDX_CARDVIEW,
                    ...
                    ANDROIDX_FRAGMENT, ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_RECYCLERVIEW, ANDROIDX_RESOURCEINSPECTION_ANNOTATION, ANDROIDX_TRANSITION,
                    ANDROIDX_VECTORDRAWABLE, ANDROIDX_VIEWPAGER2, GOOGLE_ERROR_PRONE_ANNOTATIONS, KOTLIN_STDLIB), "com.google.android.material"),
            ...
            new BuiltInLibrary(PLAY_SERVICES_ADS, List.of(ANDROIDX_BROWSER, ANDROIDX_COLLECTION, ANDROIDX_CORE, PRIVACYSANDBOX_ADSSERVICES,
                    PRIVACYSANDBOX_ADSSERVICES_JAVA, ANDROIDX_WEBKIT, PLAY_SERVICES_ADS_BASE, PLAY_SERVICES_ADS_IDENTIFIER, PLAY_SERVICES_ADS_LITE,
            ...
            new BuiltInLibrary(PLAY_SERVICES_ADS_LITE, List.of(ANDROIDX_WORK_RUNTIME, PLAY_SERVICES_ADS_BASE, PLAY_SERVICES_BASEMENT,
                    PLAY_SERVICES_MEASUREMENT_SDK_API, UMP_USER_MESSAGING_PLATFORM), "com.google.android.gms.ads"),

            new BuiltInLibrary(PLAY_SERVICES_APPSET, List.of(PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS)),
            new BuiltInLibrary(PLAY_SERVICES_AUTH, List.of(ANDROIDX_FRAGMENT, ANDROIDX_LOADER, PLAY_SERVICES_AUTH_API_PHONE, PLAY_SERVICES_AUTH_BASE,
                    PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_FIDO, PLAY_SERVICES_TASKS), "com.google.android.gms.auth.api"),
            ...
            new BuiltInLibrary(PRIVACYSANDBOX_ADSSERVICES, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE_KTX, PRIVACYSANDBOX_ADSSERVICES_JAVA,
                    KOTLIN_STDLIB, KOTLIN_COROUTINES_CORE_JVM)),
            new BuiltInLibrary(PRIVACYSANDBOX_ADSSERVICES_JAVA, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CONCURRENT_FUTURES, ANDROIDX_CORE_KTX,
                    PRIVACYSANDBOX_ADSSERVICES, GUAVA, KOTLIN_STDLIB, KOTLIN_COROUTINES_CORE_JVM)),
