...
public class AppThemeApply {
	public static void setUpTheme(Context context){
    	...
    	SharedPreferences MaterialThemeSaver = context.getSharedPreferences("MaterialTheme", Context.MODE_PRIVATE);
    	...
    	if (MaterialThemeEnable.getBoolean("MaterialThemeEnable",false)){
        	...
        	if (MaterialThemeSaver.getString("MaterialTheme","Red Dark") == "Red"){
        		context.setTheme(R.style.MaterialTheme);
        	}
        	else if (MaterialThemeSaver.getString("MaterialTheme","Red Dark") == "Red Dark") {
