...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences() {
        preferences.add(createPreference(R.drawable.block_96_blue, "Block manager", "Manage your own blocks to use in Logic Editor", new ActivityLauncher(new Intent(getApplicationContext(), BlocksManager.class)), false));
        preferences.add(createPreference(R.drawable.pull_down_48, "Block selector menu manager", "Manage your own block selector menus", openSettingsActivity(SettingsActivity.BLOCK_SELECTOR_MANAGER_FRAGMENT), false));
        preferences.add(createPreference(R.drawable.collage_48, "Component manager", "Manage your own components", new ActivityLauncher(new Intent(getApplicationContext(), ManageCustomComponentActivity.class)), false));
        preferences.add(createPreference(R.drawable.event_on_item_clicked_48dp, "Event manager", "Manage your own events", openSettingsActivity(SettingsActivity.EVENTS_MANAGER_FRAGMENT), false));
        preferences.add(createPreference(R.drawable.colored_box_96, "Local library manager", "Manage and download local libraries", new ActivityLauncher(new Intent(getApplicationContext(), ManageLocalLibraryActivity.class), new Pair<>("sc_id", "system")), false));
        preferences.add(createPreference(R.drawable.engineering_48, "Mod settings", "Change general mod settings", new ActivityLauncher(new Intent(getApplicationContext(), ConfigActivity.class)), false));
        ...
        preferences.add(createPreference(R.mipmap.ic_type_folder, "Open working directory", "Open Sketchware Pro's directory and edit files in it", v -> openWorkingDirectory(), false));
        preferences.add(createPreference(R.drawable.ic_apk_color_96dp, "Sign an APK file with testkey", "Sign an already existing APK file with testkey and signature schemes up to V4", v -> signApkFileDialog(), false));
        preferences.add(createPreference(R.drawable.icons8_app_components, getString(R.string.design_drawer_menu_title_logcat_reader), getString(R.string.design_drawer_menu_subtitle_logcat_reader), new ActivityLauncher(new Intent(getApplicationContext(), LogReaderActivity.class)), false));
