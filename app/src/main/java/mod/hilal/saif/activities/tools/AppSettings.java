...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupViews() {
        ...
        createToolsView(R.drawable.ic_mtrl_pull_down, "Block selector menu manager", "Manage your own block selector menus", content, openSettingsActivity(SettingsActivity.BLOCK_SELECTOR_MANAGER_FRAGMENT), false);
        createToolsView(R.drawable.ic_mtrl_component, "Component manager", "Manage your own components", content, new ActivityLauncher(new Intent(getApplicationContext(), ManageCustomComponentActivity.class)), false);
        createToolsView(R.drawable.ic_mtrl_list, "Event manager", "Manage your own events", content, openSettingsActivity(SettingsActivity.EVENTS_MANAGER_FRAGMENT), false);
        ...
        createToolsView(R.drawable.ic_mtrl_settings_applications, "Mod settings", "Change general mod settings", content, new ActivityLauncher(new Intent(getApplicationContext(), ConfigActivity.class)), false);
