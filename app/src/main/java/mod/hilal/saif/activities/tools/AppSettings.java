...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        preferences.add(createPreference(R.drawable.ic_mtrl_star, Helper.getResString(R.string.groq_ai_settings), Helper.getResString(R.string.groq_ai_settings_description), new ActivityLauncher(new Intent(getApplicationContext(), pro.sketchware.activities.settings.ManageGroqActivity.class))));
