...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences() {
        ...
        preferences.add(createPreference(R.mipmap.ic_mtrl_folder, "Open working directory", "Open Sketchware Pro's directory and edit files in it", v -> openWorkingDirectory(), false));
