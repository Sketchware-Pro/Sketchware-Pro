package ide.sketchware.activities.main.fragments.projects;
...
import ide.sketchware.activities.main.activities.MainActivity;
import ide.sketchware.codeproject.ui.CreateCodeProjectActivity;
import ide.sketchware.databinding.MyprojectsBinding;
import ide.sketchware.databinding.SortProjectDialogBinding;
...
public class ProjectsFragment extends DA {
    ...
    public void toDesignActivity(String sc_id) {
        // Block editor removed — inform user and offer to create a code project instead
        android.widget.Toast.makeText(requireContext(),
                R.string.code_project_block_not_supported, android.widget.Toast.LENGTH_LONG).show();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fab.setTooltipText(getString(R.string.code_project_new_project_hint));
