...
public class ProjectLibraryBean implements Parcelable {
    ...
    public String useYn;
    @Expose
    public HashMap<String, Object> material3Configurations;
    ...
    public ProjectLibraryBean(int i) {
        ...
        material3Configurations = new HashMap<>(); // Using HashMap since I’ll be adding more settings later — it fits best for that
    }
    ...
    public void copy(ProjectLibraryBean projectLibraryBean) {
        ...
        material3Configurations = new HashMap<>(projectLibraryBean.material3Configurations);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeMap(material3Configurations);
    }
