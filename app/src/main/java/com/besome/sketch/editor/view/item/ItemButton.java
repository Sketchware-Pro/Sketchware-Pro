...
public class ItemButton extends AppCompatButton implements sy {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.besome.sketch.editor.view.item.ItemButton */
    ...
    public void onDraw(Canvas canvas) {
        ...
        ItemButton.super.onDraw(canvas);
    }
    ...
    public void setBackgroundColor(int i) {
        if (i == 16777215) {
            ...
            ItemButton.super.setBackgroundColor(i);
        }
    }
