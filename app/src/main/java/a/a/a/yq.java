...
public class yq {
    ...
    public ArrayList<SrcCodeBean> a(hC hCVar, eC eCVar, iC iCVar, boolean z2) {
         ...
         */
        srcCodeBeans.add(new SrcCodeBean("SketchwareUtil.java", FileUtil.isExistFile(javaDir + "SketchwareUtil.java")? FileUtil.readFile(javaDir + "SketchwareUtil.java") : Lx.j(Lx.i(e))));
        srcCodeBeans.add(new SrcCodeBean("FileUtil.java", FileUtil.isExistFile(javaDir + "FileUtil.java")? FileUtil.readFile(javaDir + "FileUtil.java") : Lx.e(e)));
        srcCodeBeans.add(new SrcCodeBean("RequestNetwork.java", FileUtil.isExistFile(javaDir + "RequestNetwork.java")? FileUtil.readFile(javaDir + "RequestNetwork.java") : Lx.j(Lx.h(e))));
        srcCodeBeans.add(new SrcCodeBean("RequestNetworkController.java", FileUtil.isExistFile(javaDir + "RequestNetworkController.java")? FileUtil.readFile(javaDir + "RequestNetworkController.java") : Lx.j(Lx.g(e))));
        srcCodeBeans.add(new SrcCodeBean("BluetoothConnect.java", FileUtil.isExistFile(javaDir + "BluetoothConnect.java")? FileUtil.readFile(javaDir + "BluetoothConnect.java") : Lx.j(Lx.b(e))));
        srcCodeBeans.add(new SrcCodeBean("BluetoothController.java", FileUtil.isExistFile(javaDir + "BluetoothController.java")? FileUtil.readFile(javaDir + "BluetoothController.java") : Lx.j(Lx.c(e))));
        if (N.m) {
            srcCodeBeans.add(new SrcCodeBean("GoogleMapController.java", FileUtil.isExistFile(javaDir + "GoogleMapController.java")? FileUtil.readFile(javaDir + "GoogleMapController.java") : Lx.j(Lx.f(e))));
        }
