...
public class yq {
    ...
    public ArrayList<SrcCodeBean> a(hC hCVar, eC eCVar, iC iCVar, boolean z2) {
         ...
         */
        srcCodeBeans.add(new SrcCodeBean("SketchwareUtil.java", FileUtil.isExistFile(javaDir + "SketchwareUtil.java")? FileUtil.readFile(javaDir + "SketchwareUtil.java") : Lx.i(e)));
        ...
        srcCodeBeans.add(new SrcCodeBean("RequestNetwork.java", FileUtil.isExistFile(javaDir + "RequestNetwork.java")? FileUtil.readFile(javaDir + "RequestNetwork.java") : Lx.h(e)));
        srcCodeBeans.add(new SrcCodeBean("RequestNetworkController.java", FileUtil.isExistFile(javaDir + "RequestNetworkController.java")? FileUtil.readFile(javaDir + "RequestNetworkController.java") : Lx.g(e)));
        srcCodeBeans.add(new SrcCodeBean("BluetoothConnect.java", FileUtil.isExistFile(javaDir + "BluetoothConnect.java")? FileUtil.readFile(javaDir + "BluetoothConnect.java") : Lx.b(e)));
        srcCodeBeans.add(new SrcCodeBean("BluetoothController.java", FileUtil.isExistFile(javaDir + "BluetoothController.java")? FileUtil.readFile(javaDir + "BluetoothController.java") : Lx.c(e)));
        if (N.m) {
            srcCodeBeans.add(new SrcCodeBean("GoogleMapController.java", FileUtil.isExistFile(javaDir + "GoogleMapController.java")? FileUtil.readFile(javaDir + "GoogleMapController.java") : Lx.f(e)));
        }
