...
public class yq {
    ...
    public ArrayList<SrcCodeBean> a(hC hCVar, eC eCVar, iC iCVar, boolean z2) {
        ...
        final String javaDir = FileUtil.getExternalStorageDir() + "/.sketchware/data/" + d + "/files/java/";
        final String layoutDir = FileUtil.getExternalStorageDir() + "/.sketchware/data/" + d + "/files/resource/layout/";
        ...
        for (ProjectFileBean bean : hCVar.b()) {
            arrayList.add(new SrcCodeBean(bean.getJavaName(), FileUtil.isExist(javaDir + bean.getJavaName())? FileUtil.readFile(javaDir + bean.getJavaName()) : new Jx(N, bean, eCVar).a()));
        }
        ...
        for (ProjectFileBean bean : hCVar.b()) {
            ...
            arrayList.add(new SrcCodeBean(xmlName, FileUtil.isExist(layoutDir + xmlName)? FileUtil.readFile(layoutDir + xmlName) : CommandBlock.applyCommands(xmlName, ox.b())));
        }
        for (ProjectFileBean bean : hCVar.c()) {
            String xmlName2 = bean.getXmlName();
            Ox ox2 = new Ox(N, bean);
            ox2.a(eC.a(eCVar.d(xmlName2)));
            arrayList.add(new SrcCodeBean(xmlName2, FileUtil.isExist(layoutDir + xmlName2)? FileUtil.readFile(layoutDir + xmlName2) : CommandBlock.applyCommands(xmlName2, ox2.b())));
        }
         ...
         */
        srcCodeBeans.add(new SrcCodeBean("SketchwareUtil.java", FileUtil.isExist(javaDir + "SketchwareUtil.java")? FileUtil.readFile(javaDir + "SketchwareUtil.java") : Lx.i(e)));
        srcCodeBeans.add(new SrcCodeBean("FileUtil.java", FileUtil.isExist(javaDir + "FileUtil.java")? FileUtil.readFile(javaDir + "FileUtil.java") : Lx.e(e)));
        srcCodeBeans.add(new SrcCodeBean("RequestNetwork.java", FileUtil.isExist(javaDir + "RequestNetwork.java")? FileUtil.readFile(javaDir + "RequestNetwork.java") : Lx.h(e)));
        srcCodeBeans.add(new SrcCodeBean("RequestNetworkController.java", FileUtil.isExist(javaDir + "RequestNetworkController.java")? FileUtil.readFile(javaDir + "RequestNetworkController.java") : Lx.g(e)));
        srcCodeBeans.add(new SrcCodeBean("BluetoothConnect.java", FileUtil.isExist(javaDir + "BluetoothConnect.java")? FileUtil.readFile(javaDir + "BluetoothConnect.java") : Lx.b(e)));
        srcCodeBeans.add(new SrcCodeBean("BluetoothController.java", FileUtil.isExist(javaDir + "BluetoothController.java")? FileUtil.readFile(javaDir + "BluetoothController.java") : Lx.c(e)));
        if (N.m) {
            srcCodeBeans.add(new SrcCodeBean("GoogleMapController.java", FileUtil.isExist(javaDir + "GoogleMapController.java")? FileUtil.readFile(javaDir + "GoogleMapController.java") : Lx.f(e)));
        }
