...
import mod.agus.jcoderz.lib.TypeWidgetSelector;
...
public class wq {
    ...
    public static final String[] G = new String[]{"subs_year_01", "subs_50_year_01", "subs_30_year_01", "subs_20_year_01", "subs_month_06", "subs_month_03", "subs_month_01", "subs_50_month_01", "subs_30_month_01", "subs_20_month_01"};
    public static final long[] H = new long[]{32140800000L, 32140800000L, 32140800000L, 32140800000L, 16070400000L, 8035200000L, 2678400000L, 2678400000L, 2678400000L, 2678400000L};
    public static final String[] I = new String[]{"subs_month_01", "subs_year_01"};
    public static final String[] J = new String[]{"subs_50_month_01", "subs_50_year_01"};
    public static final String[] K = new String[]{"subs_30_month_01", "subs_30_year_01"};
    public static final String[] L = new String[]{"subs_20_month_01", "subs_20_year_01"};
    public static final String[] M = new String[]{"F83085529A75E7A8CEDD64013B1A374B", "90C443DFAB7F23424DE7E079787466CD", "F83085529A75E7A8CEDD64013B1A374B", "C99E5B3F179203AE2749F8F9B5A7493A", "100EFD7391FF1BEE4A1E2F960A1B8AF2"};
    public static final String[] N = new String[]{"1486507718310013_1788685811425534", "1486507718310013_1804931006467681", "1486507718310013_1805009746459807", "1486507718310013_1805001526460629", "1486507718310013_1805273579766757", "1486507718310013_1805397669754348", "1486507718310013_1805436593083789", "1486507718310013_1805666736394108", "1486507718310013_1805724186388363", "1486507718310013_1809233042704144"};
    public static final String[] O = new String[]{"255022168522663_266931247331755", "255022168522663_268282677196612", "255022168522663_268283823863164", "255022168522663_266575314034015", "255022168522663_279474749410738"};
    public static final String[] P = new String[]{"Activity", "CustomView"};
    ...
    public static String b(int type) {
        ...
        switch (type) {
            ...
            case 16:
            default:
                selectorType = TypeWidgetSelector.a(type);
                break;

            case 2:
                selectorType = "hscroll";
                break;
            ...
            case 4:
                selectorType = "textview";
                break;

            case 5:
                selectorType = "edittext";
                break;
            case 6:
                selectorType = "imageview";
                break;
            case 7:
                selectorType = "webview";
                break;
            case 8:
                selectorType = "progressbar";
                break;
            case 9:
                selectorType = "listview";
                break;
            case 10:
                selectorType = "spinner";
                break;
            case 11:
                selectorType = "checkbox";
                break;
            case 12:
                selectorType = "vscroll";
                break;
            case 13:
                selectorType = "switch";
                break;
            case 14:
                selectorType = "seekbar";
                break;
            case 15:
                selectorType = "calendarview";
                break;
            case 17:
                selectorType = "adview";
                break;
            case 18:
                selectorType = "mapview";
                break;
            case 19:
